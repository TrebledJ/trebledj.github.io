...
{% image "assets/guitar-strumming-by-jefferson-santos.jpg", "Guitar Strumming (Jefferson Santos)", "w-40 float-right-md rw-md" %}
...
{% image "assets/offramp-following-god.jpg", "", "w-25 m-1 float-right rw" %}
...
{% image "assets/god-is-my-refuge-by-alex-shute.jpg", "'God is my refuge.' in Scrabble.", "w-45 m-1 float-right rw" %}
...
{% image "assets/overflow.jpg", "Fruits. Fruits everywhere.", "w-30 m-1 float-right rw" %}
