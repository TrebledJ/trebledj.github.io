...
{% image "assets/ezpz-rev-main.jpg", "w-55", "Decompiled output of the main function." %}
...
{% image "assets/ezpz-rev-init.jpg", "w-75", "Decompiled output of the initialisation function." %}
...
{% image "assets/ezpz-rev-guards.jpg", "w-65", "Ten-huttt!", "Four King's Guards marching along." %}
...
{% image "assets/ezpz-rev-test1.jpg", "w-75", "Decompiled output of the first guard." %}
...
{% image "assets/ezpz-rev-test2.jpg", "w-75", "Decompiled output of the second guard." %}
...
{% image "assets/ezpz-rev-test3.jpg", "w-95", "Decompiled output of the third guard." %}
...
{% image "assets/ezpz-rev-test4.jpg", "w-80", "Decompiled output of the fourth guard." %}
...
{% image "assets/reverse-ultrascan.jpg", "w-50", "Charging... Focusing reverse energy... Ultrascan activated...", "Squinting meme." %}
