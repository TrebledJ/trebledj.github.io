...
{% image "assets/ezpz-rev-main.jpg", "Decompiled output of the main function.", "w-55" %}
...
{% image "assets/ezpz-rev-init.jpg", "Decompiled output of the initialisation function.", "w-75" %}
...
{% image "assets/ezpz-rev-guards.jpg", "Ten-huttt!", "w-65" %}
...
{% image "assets/ezpz-rev-test1.jpg", "Decompiled output of the first guard.", "w-75" %}
...
{% image "assets/ezpz-rev-test2.jpg", "Decompiled output of the second guard.", "w-75" %}
...
{% image "assets/ezpz-rev-test3.jpg", "Decompiled output of the third guard.", "w-95" %}
...
{% image "assets/ezpz-rev-test4.jpg", "Decompiled output of the fourth guard.", "w-80" %}
...
{% image "assets/reverse-ultrascan.jpg", "Loading... Focusing reverse energy... Ultrascan activated...", "w-50" %}
