...
{% image "assets/ezpz-rev-main.jpg", "Decompiled output of the main function.", "post1 w-50" %}
...
{% image "assets/ezpz-rev-init.jpg", "Decompiled output of the initialisation function.", "post1 w-70" %}
...
{% image "assets/ezpz-rev-guards.jpg", "Ten-huttt!", "post1 w-60" %}
...
{% image "assets/ezpz-rev-test1.jpg", "Decompiled output of the first guard.", "post1 w-70" %}
...
{% image "assets/ezpz-rev-test2.jpg", "Decompiled output of the second guard.", "post1 w-70" %}
...
{% image "assets/ezpz-rev-test3.jpg", "Decompiled output of the third guard.", "post1 w-90" %}
...
{% image "assets/ezpz-rev-test4.jpg", "Decompiled output of the fourth guard.", "post1 w-75" %}
...
{% image "assets/reverse-ultrascan.jpg", "Loading... Focusing reverse energy... Ultrascan activated...", "post1 w-45" %}
