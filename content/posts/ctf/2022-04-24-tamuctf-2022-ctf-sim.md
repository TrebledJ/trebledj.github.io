...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-1-heap-init.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-2-input-1.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-3a-heap-after-input-1.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-3b-vtables-party.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-4a-disas-1.jpg", "", "post1" %}

{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-4b-disas-2.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-4c-double-deref-in-first-solve.jpg", "", "post1" %}

So *this* is what happens when we call a virtual function... InTeReStInG!

{% image "assets/img/posts/memes/interesting.jpg", "", "post1 w-75" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-5-heap-after-input-2.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-6-input-3.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-7-heap-after-input-3.jpg", "", "post1" %}
...
{% image "assets/img/posts/misc/ctf/ctf-sim/ctf-sim-9-sigsev.jpg", "", "post1" %}
