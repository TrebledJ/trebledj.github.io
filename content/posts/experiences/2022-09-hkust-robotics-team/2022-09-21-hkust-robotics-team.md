...
{% image "assets/off-ramp-robotics.jpg", "Bye bye CGA.", "post1 w-50" %}
...
{% image "assets/chassis-example.jpg", "Example of the chassis used.", "post1 w-30" %}
...
{% image "assets/training.jpg", "Training is tuff!", "post1 w-50" %}
