...
tags: 
 ...
 - apps
 - reflection
thumbnail_src: assets/cashier.jpg
...
{% image "assets/rfid.jpg", "Exhibit A: an RFID", "post1 w-45" %}
...
{% image "assets/sfml-is-not-cute.jpg", "SFML is not cute.", "post1 w-45" %}
...
{% image "assets/netwhat.jpg", "Net-what?", "post1 w-45" %}
...
{% image "assets/vendor-order.jpg", "Vendor ordering UI.", "post1 w-85" %}
...
{% image "~/assets/img/memes/unlimited-power.jpg", "Unnnnnlliiiimmiiitted pooower!.", "post1 w-55" %}
