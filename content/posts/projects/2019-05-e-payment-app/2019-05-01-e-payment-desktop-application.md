...
{% image "assets/rfid.jpg", "Exhibit A: an RFID", "post1 w-40" %}
...
{% image "assets/sfml-is-not-cute.jpg", "SFML is not cute.", "post1 w-40" %}
...
{% image "assets/netwhat.jpg", "Net-what?", "post1 w-40" %}
...
{% image "assets/vendor-order.jpg", "Vendor ordering UI.", "post1 w-80" %}
...
{% image "~/assets/img/memes/unlimited-power.jpg", "Unnnnnlliiiimmiiitted pooower!.", "post1 w-50" %}
