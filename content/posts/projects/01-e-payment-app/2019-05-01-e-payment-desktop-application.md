...
{% image "assets/rfid.jpg", "jw-45", "Exhibit A: an RFID" %}
...
{% image "assets/sfml-is-not-cute.jpg", "jw-45", "SFML is not cute." %}
...
{% image "assets/netwhat.jpg", "jw-45", "Net-what?" %}
...
{% image "assets/vendor-order.jpg", "jw-85", "Vendor ordering UI." %}
...
{% image "~/assets/img/memes/unlimited-power.jpg", "jw-55", "Unnnnnlliiiimmiiitted pooower!." %}
