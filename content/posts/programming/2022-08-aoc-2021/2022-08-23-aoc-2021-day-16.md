...
tags:
 ...
 - haskell
 - writeup
thumbnail: assets/aoc-2021-day-16-thumbnail.jpg
related:
  tags: [aoc, haskell]
---
...
{% alert "info" %}
The template I'm using allows me to solve a challenge by writing three functions: `parse :: Parser Packet`, `part1 :: Packet -> Int`, and `part2 :: Packet -> Int`. These will be covered in this post. The driver code of the template (`defaultMain`) is elaborated in my [Haskell utilities][haskell-utils] post.
{% endalert %}
