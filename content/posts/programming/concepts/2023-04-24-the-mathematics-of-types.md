...
{% image "assets/sheesh-sum-types.jpg", "Sum types stand out from the historic dominance of product types.", "w-55" %}
...
{% image "assets/wild-types.jpg", "std::any — I choose you!", "w-45" %}
