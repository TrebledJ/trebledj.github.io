...
{% image "assets/tick-tock.jpg", "Tick tock likey embedded timers?", "post1 w-50" %}
...
{% image "assets/timing-diagram.jpg", "Timing diagram of timer signal derived from a clock signal.", "post1 w-80" %}
...
{% image "assets/stm32-cubemx-timer-1.jpg", "Timer settings from CubeMX.", "post1 w-80" %}
...
{% image "assets/stm32-cubemx-timer-2-raw.jpg", "More timer settings from CubeMX.", "post1 w-60" %}
...
{% image "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/CPT-Sound-ADC-DAC.svg/1200px-CPT-Sound-ADC-DAC.svg.png", "Tolkien's world looks nothing like the three realms here.", "post1 w-80" %}
...
{% image "assets/sampling.jpg", "Free samples have returned!", "post1 w-80" %}
...
{% image "assets/reconstruction.jpg", "Free samples have returned!", "post1 w-80" %}
...
{% image "assets/stm32-cubemx-dac-1.jpg", "DAC settings from CubeMX.", "post1 w-80" %}
...
{% image "assets/stm32-cubemx-dac-2.jpg", "DAC DMA settings from CubeMX.", "post1 w-60" %}

<sup>Configure DMA settings for the DAC. We’ll cover DMA later.</sup>
{.caption}

{% image "assets/stm32-cubemx-dac-3.jpg", "Enable DAC DMA interrupts.", "post1 w-60" %}
...
{% image "assets/stm32-dac-alignment.jpg", "Three options for DAC alignment are offered.", "post1 w-60" %}
...
{% image "assets/osc-square-wave.jpg", "A square wave at 100Hz.", "post1 w-60" %}
...
{% image "assets/y-u-no-faster.jpg", "HAL Delay, y u no faster?", "post1 w-40" %}
...
{% image "assets/single-buffer.jpg", "Single buffers... forever alone.", "post1 w-40" %}
...
{% image "assets/osc-sine-440-glitch.jpg", "Artefacts distort the signal, resulting in occasionally clips and sound defects.", "post1 w-60" %}
...
<a id="stall-img"></a>
{% image "assets/osc-sine-440-stall.jpg", "Oscilloscope of sine wave with stalls (horizontal breaks with no change).", "post1 w-60" %}
...
{% image "assets/osc-sine-440-2.jpg", "Pure sine goodness. A proper 440Hz sine displaying properly.", "post1 w-60" %}
...
{% image "assets/osc-a-major.jpg", "The curves are mesmerising.", "post1 w-60" %}
