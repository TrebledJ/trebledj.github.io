...
{% image "assets/fourier-analysis.jpg", "Skipper's partial to Fourier. They're the best of chums.", "post1 w-50" %}
...
{% image "assets/additive-synthesis.jpg", "Example of additive synthesis, localised on this very webpage.", "post1 w-60" %}
...
{% video "assets/wavetable-synthesis.mp4", "post1 w-70" %}
