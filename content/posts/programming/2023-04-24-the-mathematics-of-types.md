...
{% image "assets/img/posts/programming/sheesh-sum-types.jpg", "Sum types stand out from the historic dominance of product types.", "w-80" %}
...
{% image "assets/img/posts/programming/wild-types.jpg", "std::any — I choose you!", "w-90" %}
