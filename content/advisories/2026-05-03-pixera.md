...
{% image "cvd_1_rce_local_pop_calc.png", "", "Run calc.exe in a local deployment" %}
...
{% image "cvd_1_rce_reverse_shell.png", "", "Obtain a reverse shell in a remote deployment" %}
...
{% image "cvd_2_path_traversal_winini.png", "", "Path traversal to win.ini" %}
...
{% image "cvd_2_path_traversal_build_version.png", "", "Path traversal to a file containing the Pixera build version" %}
