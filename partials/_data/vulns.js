const VULNS = [
    {
        ...
        description: 'The Siemens APOGEE PXC and TALON TC Series are a collection of field panels used for complex control, monitoring, and energy management within commercial buildings. They interconnect with other components to form a building automation system, often communicating via BACnet over IP. It is possible to "chain" CVE-2025-40757 and CVE-2024-54089 to bypass authentication and takeover/shutdown the affected devices.',
        items: [
            {
                type: 'cve',
                name: 'CVE-2024-54089',
    ...
    },
    {
        ...
        tags: ['web'],
        description: 'Oracle Hospitality OPERA is a property management system (PMS) used by hotels, resorts, and chains to manage daily operations such as reservations, check-ins, room assignments, billing, and revenue.',
        items: [
            {
                type: 'cve',
                name: 'CVE-2026-21966',
