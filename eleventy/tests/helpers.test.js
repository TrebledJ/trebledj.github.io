...
import fs from 'fs';
import { stripBetweenTags, modifyExternalLinksToOpenInSeparateTab } from '../detail/helpers';
...
test('modifyExternalLinksToOpenInSeparateTab', () => {
  ...
  expect(modifyExternalLinksToOpenInSeparateTab(before)).toBe(after);
});
